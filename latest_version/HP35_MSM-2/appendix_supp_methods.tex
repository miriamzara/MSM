...
transition matrix $T(\tau)$ estimated at a fixed lag time $\tau$.
Following the convention used in \textsc{deeptime}~\cite{Deeptime2021},
$T$ is taken to be row-stochastic,
\begin{equation}
...
microstates into metastable macrostates. I use this to connect the
slowest exchange modes of the Markov chain to the folded/unfolded
thermodynamics of the protein, keeping in mind that spectral
metastability and thermodynamic stability are related but not strictly
identical notions.
