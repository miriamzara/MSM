...
\begin{figure}[h!]
    ...
    \label{suppfig:contact_map_folded_vs_other}
\end{figure}
...
\begin{figure*}[ht]
    ...
    \label{suppfig:threestate_tica_distances}
\end{figure*}
...
\begin{figure*}[ht]
    ...
    \includegraphics[width=0.2\linewidth]{figures/dihedrals_ramachandran_macrostate_comparison.pdf}
    \includegraphics[width=0.7\linewidth]{figures/tica_dihedrals_3_pcca_coring_trajectory.pdf}
    \caption{\small {Trajectory of the three-state PCCA++ model for tICA-dihedrals.}}
