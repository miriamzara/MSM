...
%
\vspace{0.5em}\newline
\textbf{Spectral analysis and Coarse-graining}
...
\begin{figure*}[ht]
    ...
    \caption{\footnotesize \textbf{Free energy projections on the reduced coordinates.}}
\end{figure*}
\vspace{0.5em}\newline
...
\begin{figure}[!t]
    ...
    \caption{\footnotesize \textbf{Results of the autocorrelation test:} {
        Autocorrelation function of the root mean square deviation (RMSD) from the crystal structure, as obtained 
        from the molecular dynamics trajectory (blue) and predicted by the four MSMs (orange, green, red and purple).
        \color{orange} TODO: add uncertainties using bootstrapping}
        }
    \label{fig:autocorrelation}
\end{figure}
Validation was performed as described in Methods comparing the autocorrelation function of the RMSD to the crystal structure computed from the trajectory and predicted by the MSMs (see Fig.\ref{fig:autocorrelation}).
...
\subsection{Spectral decomposition of the transition matrix of a Markov chain \textcolor{orange}{TO COMPLETE}}
\label{si:spectral}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{figures/pairwise_pcca_membership_scatter_quadrants_report.pdf}
