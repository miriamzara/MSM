...
\begin{figure*}[ht]
    ...
    \includegraphics[width=0.7\linewidth]{figures/implied_timescales.png}
    \includegraphics[width=0.2\linewidth]{figures/autocorrelation_rmsd.png}
    \caption{\footnotesize Results of the MSM construction pipeline. \textbf{Top.} projected free-energy surfaces onto the first two reduced coordinates for the four feature-reduction pipelines considered. \textbf{Middle left.}
     First three implied timescales as a function of the MSM lagtime. Colors denote the four combinations of feature set and dimensionality reduction method, while marker styles indicate the number of microstates used in the state-space discretization. 
        ...
        as the associated relaxation process occurs on a timescale shorter than a single Markov-chain transition step. \textbf{Middle right:} Autocorrelation function of the root mean square deviation (RMSD) from the crystal structure, as obtained 
