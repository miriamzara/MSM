...
\vspace{0.5em}\newline
\textbf{Coarse-graining {\color{orange} TODO}}
\vspace{0.5em}\newline
\textbf{Transition Path Theory (TPT) analysis {\color{orange} maybe? maybe not?}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
%
...
\begin{center}
    ...
    \captionof{figure}{\small \textbf{Flowchart of the MSM construction pipeline used in this work}.}
